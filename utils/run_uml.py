...
def main():
    ...
    if not args:
        ...
        print("\nAvailable commands:")
        print("  run_uml_generator.py                  - Generate all UML diagrams")
        print("  extract_class.py --source PATH        - Generate class diagrams")
        print("  extract_sequence.py --source PATH     - Generate sequence diagrams")
        print("  extract_activity.py --source PATH     - Generate activity diagrams")
        print("  extract_state.py --source PATH        - Generate state diagrams")
        print(
            "  uml/run.py --type TYPE --source PATH  - Generate diagrams with more options"
        )
        print("\nExamples:")
        print("  python utils/run_uml.py run_uml_generator.py")
        print("  python utils/run_uml.py extract_class.py --source backend/app")
